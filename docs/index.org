...
We could simply switch to /text-mode/ and perform the edit operation there, but we can do better by moving the point to the end of line by pressing =u= in command mode:
#+attr_html: :alt problem :title problem :width 100%
[[file:images/om-problem4.png]]
The point is now at the very end of the previous line.
Now, all we have to do is insert a new line below the point by pressing =C-o=:
#+attr_html: :alt problem :title problem :width 100%
