...
*** Proselint
:PROPERTIES:
:CUSTOM_ID: dictionaries-etc-proselint
:END:
...
[[file:images/proselint.png]]
*** Writegood-mode
:PROPERTIES:
:CUSTOM_ID: dictionaries-etc-writegood-mode
:END:
...
[[file:images/writegood-mode.png]]
...
:PROPERTIES:
:CUSTOM_ID: looking-good-and-being-comfortable
:END:
*** Themes and fonts
:PROPERTIES:
:CUSTOM_ID: looking-good-and-being-comfortable-themes-and-fonts
:END:
*** Zen-mode and transparency
:PROPERTIES:
:CUSTOM_ID: looking-good-and-being-comfortable-zen-mode-and-transparency
:END:
...
:PROPERTIES:
:CUSTOM_ID: looking-good-and-being-comfortable-scroll-center-cursor-mode
:END:
** Org-roam
:PROPERTIES:
:CUSTOM_ID: org-roam
...
:END:
**** Zotero
[[https://www.zotero.org/][:PROPERTIES:
